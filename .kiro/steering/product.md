...
Uses Clerk for authentication with sign-in/sign-up flows and user profiles.

## Internationalization

Supports English and Chinese locales via `src/locales/` JSON files and `LanguageContext`.
