...
export async function GET(request: NextRequest) {
  try {
    console.log(`Proxying GET request to ${FASTAPI_URL}/config/semrush`);

    const response = await fetchWithTimeout(
      `${FASTAPI_URL}/config/semrush`,
      {
        headers: {
    ...
    console.error(`Error proxying GET request to /config/semrush:`, error);
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log(`Proxying POST request to ${FASTAPI_URL}/config/semrush`);
    ...
    console.error(`Error proxying POST request to /config/semrush:`, error);
